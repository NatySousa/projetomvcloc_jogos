...
namespace ProjetoMVC_LocJogos.Reports
{
    public class JogoReport
    {
    ...
    List<Jogo> jogos)
        {
            ...
            using (var document = new Document(pdf))
            {
                ...
                document.Add(new Paragraph
                    ($"Jogos cadastrados entre: { dataMin.ToString("dd/MM/yyyy") } e { dataMax.ToString("dd/MM/yyyy")} ")
                ...
                table.AddHeaderCell("Nome do Jogo");
...
(new DeviceRgb(0, 0, 0)));
        ...
        private Image ObterLogotipo
        {
            get
            {
                ImageData imageData = ImageDataFactory.Create(new Uri("https://gecon.es/wp-content/uploads/2014/11/gameover.jpg"));
